...
|-----------|-------------------|
| North Star alignment | Does it bring closer to or farther from the goal? |
| Recruiter signal | What do HMs think seeing this on a CV? |
...
Training that improves credibility in "production-grade AI research":
